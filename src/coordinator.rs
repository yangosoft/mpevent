mod coordinator {
    ...
    impl Coordinator {
        pub(crate) fn new(mem_path: &str) -> Self {
        ...
        pub(crate) fn open_existing(mem_path: &str) -> Self {
            let mut tmp_shm = posixaccessor::POSIXShm::<Directory>::new(
                mem_path.to_string(),
                std::mem::size_of::<Directory>(),
            );
        ...
        pub(crate) fn close(&mut self, unlink: bool) -> Result<(), String> {
            let ret: Result<(), String>;
            unsafe {
        ...
        pub(crate) fn add_subscriber(&mut self, name: &str) -> Result<(), String> {
        ...
        pub(crate) fn add_event(&mut self, name: &str) -> Result<(), String> {
            self.mutex.lock();
        ...
        pub(crate) fn get_subscriber(&self, id: u64) -> Option<Subscriber> {
